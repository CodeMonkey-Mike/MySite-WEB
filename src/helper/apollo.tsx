...
export const createApiEndpoint = () => {
  ...
  return [process.env.NEXT_PUBLIC_API_URL, process.env.NEXT_PUBLIC_API_PR, '.', 
  process.env.NEXT_PUBLIC_API_DOMAIN, process.env.NEXT_PUBLIC_API_PATH].join('');
};

export const client = new ApolloClient({
  ssrMode: typeof window === 'undefined',
  uri: createApiEndpoint() || 'http://localhost:4000/graphql',
