...
export const useTags = (tag: string | undefined) => {
  const { data: blogPosts, loading: _blogLoading, refetch: _blogRefetch } = useQuery(BLOG, {variables: {page: 1, pageSize: 10, tag,}});
